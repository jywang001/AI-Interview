...
| Locally generated Demo resume PDFs | The fictional AI algorithm and AI application material set above | `scripts/build_demo_resumes.py` can generate two local PDF fixtures with Python and ReportLab; generated PDF binaries are ignored by Git | No reference asset or personal data is used; generated files are for local upload testing only | Verified 2026-08-30 |
